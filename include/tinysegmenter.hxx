...
private:
  inline void init_weights() {
    _BC1 = {{"EE", 0}, {"HH", 6}, {"II", 2461}, {"KH", 406}, {"OH", -1378}};
    _BC2 = {{"AA", -3267}, {"AI", 2744},  {"AN", -878},  {"EI", 10000},
            {"EN", 10000}, {"HH", -4070}, {"HM", -1711}, {"HN", 4012},
            {"HO", 3761},  {"IA", 1327},  {"IE", 10000}, {"IH", -1184},
            {"II", -4348}, {"IK", 1721},  {"IO", 5492}, {"KI", 3831},
            {"KK", -8741}, {"MH", -3132}, {"MK", 3334}, {"NM", 15000},
            {"OO", -2920}};
  ...
  inline std::string ctype_rune(char32_t r) const {
    if ((r >= 0x1F600 && r <= 0x1F64F) || (r >= 0x1F300 && r <= 0x1F5FF) ||
        (r >= 0x1F680 && r <= 0x1F6FF) || (r >= 0x1F700 && r <= 0x1F77F) ||
        (r >= 0x1F780 && r <= 0x1F7FF) || (r >= 0x1F800 && r <= 0x1F8FF) ||
        (r >= 0x1F900 && r <= 0x1F9FF) || (r >= 0x1FA00 && r <= 0x1FA6F) ||
        (r >= 0x1FA70 && r <= 0x1FAFF) || (r >= 0x2600 && r <= 0x26FF) ||
